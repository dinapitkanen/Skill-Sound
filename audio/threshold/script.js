...
function onDocumentReady() {
  ...
  document.getElementById('reset').addEventListener('click', () => {
    document.querySelectorAll('.newHit').forEach(elem => elem.classList.remove('newHit'));
  });
  document.getElementById('reset').addEventListener('click', () => {
    document.querySelectorAll('.anotherHit').forEach(elem => elem.classList.remove('anotherHit'));
  });

...
function behaviour() {
  ...
  if (Math.abs(diff) > 0.00 && diff > 0) { // Only move if there's enough of a difference & it's louder
  ...
  // Apply rotation
  thing.rotation = thing.rotation + (thing.rotationVector * 0.9);
}
